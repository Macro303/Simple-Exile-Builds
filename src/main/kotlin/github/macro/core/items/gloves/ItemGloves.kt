...
class ItemGloves(
	...
	override fun getFile(): File {
		var baseFolder = File(File("resources", "Items"), "Gloves")
		if (isUnique)
...
private class ItemGlovesDeserializer @JvmOverloads constructor(vc: Class<*>? = null) : StdDeserializer<ItemGloves?>(vc) {
