...
class ItemBodyArmour(
	...
	override fun getFile(): File {
		var baseFolder = File(File("resources", "Items"), "Armours")
		if (isUnique)
...
private class ItemBodyArmourDeserializer @JvmOverloads constructor(vc: Class<*>? = null) : StdDeserializer<ItemBodyArmour?>(vc) {
