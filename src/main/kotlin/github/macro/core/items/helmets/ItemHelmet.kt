...
class ItemHelmet(
	...
	override fun getFile(): File {
		var baseFolder = File(File("resources", "Items"), "Helmets")
		if (isUnique)
...
private class ItemHelmetDeserializer @JvmOverloads constructor(vc: Class<*>? = null) : StdDeserializer<ItemHelmet?>(vc) {
